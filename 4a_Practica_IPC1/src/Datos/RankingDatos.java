...
public class RankingDatos extends LeerDatos {
    ...
    public RankingDatos() {
        ...
        if(!existeArchivo()) {
            try {
                ...
                JOptionPane.showMessageDialog(null, "Error al leer o escribir el raking.txt");
            }
        }
    }
    ...
    public void agregarGanador(String nombre) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "Datos corruptos de ranking. Se ha borrado todo y creado denuevo");
            jugadores = new String[1][2];
            jugadores[0][0] = nombre;
            jugadores[0][1] = "1";
            crearDatos();
